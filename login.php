				...
				<div class="card">
				  ...
				  <div class="card-body">
					...
					<div id="registerMessage"></div>
					  ...
					  <div class="form-group">
						<label for="registerPassword2">Repite la Contraseña<span class="requiredIcon">*</span></label>
					  ...
					  <button type="button" id="register" class="btn btn-success">Registro</button>
					  <a href="login.php?action=resetPassword" class="btn btn-warning">Resetear Contraseña</a>
		...
		<div class="card">
		  ...
		  <div class="card-body">
			...
			<div id="loginMessage"></div>
			  ...
			  <a href="login.php?action=register" class="btn btn-success">Registro</a>
			  <a href="login.php?action=resetPassword" class="btn btn-warning">Cambiar Contraseña</a>
			  <button type="reset" class="btn">Limpiar</button>
			</form>
		  </div>
		</div>
