	...
	if(isset($_POST['loginUsername'])){
		...
		if(!empty($loginUsername) && !empty($loginUsername)){
			...
			if($checkUserStatement->rowCount() > 0){
				...
				echo '<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert">&times;</button>¡Inicio de sesión exitoso! Redirigiendo a la página de inicio...</div>';
				exit();
			} else {
