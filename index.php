<?php
	...
	require_once('controller/header.html');
?>
  <body>
<?php
	  ...
	  <div class="row">
		...
		<h1 class="my-4"></h1>
			<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
			  ...
			  <a class="nav-link" id="v-pills-vendor-tab" data-toggle="pill" href="#v-pills-vendor" role="tab" aria-controls="v-pills-vendor" aria-selected="false">Proveedor</a>
		 ...
		 <div class="col-lg-10">
			<div class="tab-content" id="v-pills-tabContent">
							...
							<form>
							  <div class="form-row">
								...
								<div class="form-group col-md-3">
								  <label for="itemDetailsProductID">ID Producto</label>
								  <input class="form-control invTooltip" type="number" readonly  id="itemDetailsProductID" name="itemDetailsProductID" title="Este ID de producto será generado automáticamente">
								</div>
							  </div>
							  <div class="form-row">
								  ...
								  <div class="form-group col-md-2">
									...
									<select id="itemDetailsStatus" name="itemDetailsStatus" class="form-control">
										<?php include('controller/statusList.html'); ?>
									</select>
								  </div>
							  </div>
							  <div class="form-row">
							  ...
							  <button type="button" id="addItem" class="btn btn-info">Agregar Producto</button>
							  <button type="button" id="updateItemDetailsButton" class="btn btn-info">Actualizar</button>
							  <button type="reset" class="btn btn-info" id="itemClear">Limpiar</button>
							  <button type="button" id="deleteItem" class="btn btn-danger">Borrar</button>
							</form>
						</div>
						<div id="itemImageTab" class="container-fluid tab-pane fade">
							<br>
							<div id="itemImageMessage"></div>
							<p>Puede cargar una imagen para un artículo en particular usando esta sección.</p> 
							<p>Asegúrese de que el elemento ya esté agregado a la base de datos antes de cargar la imagen.</p>
							<br>							
							<form name="imageForm" id="imageForm" method="post">
							  ...
							  <div class="form-row">
								  <div class="form-group col-md-7">
									<label for="itemImageFile">Selecciona Imagen ( <span class="blueText">jpg</span>, <span class="blueText">jpeg</span>, <span class="blueText">gif</span>, <span class="blueText">png</span> solamente )</label>
									<input type="file" class="form-control-file btn btn-dark" id="itemImageFile" name="itemImageFile">
								  </div>
							  </div>
							  <br>
							  <button type="button" id="updateImageButton" class="btn btn-info">Subir Imagen</button>
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">
					...
					<form>
					  <div class="form-row">
						<div class="form-group col-md-3">
						  <label for="purchaseDetailsItemNumber">N Producto<span class="requiredIcon">*</span></label>
						...
						<div class="form-group col-md-2">
						  <label for="purchaseDetailsPurchaseID">ID de Compra</label>
						  <input type="text" readonly class="form-control invTooltip" id="purchaseDetailsPurchaseID" name="purchaseDetailsPurchaseID" title="Este ID Compra será generado automáticamente" autocomplete="off">
					  ...
					  <div class="form-row"> 
						  <div class="form-group col-md-4">
							...
							<input type="text" class="form-control invTooltip" id="purchaseDetailsItemName" name="purchaseDetailsItemName" readonly title="Este campo se completará automáticamente cuando ingrese el campo N Producto arriba">
						  </div>
						  <div class="form-group col-md-2">
							  <label for="purchaseDetailsCurrentStock">Existencias Actuales</label>
							  <input type="text" class="form-control" id="purchaseDetailsCurrentStock" name="purchaseDetailsCurrentStock" readonly>
						  </div>
						  <div class="form-group col-md-4">
							<label for="purchaseDetailsVendorName">Nombre de Proveedor<span class="requiredIcon">*</span></label>
							<select id="purchaseDetailsVendorName" name="purchaseDetailsVendorName" class="form-control">
								<?php 
					  ...
					  <button type="button" id="addPurchase" class="btn btn-info">Agregar Compra</button>
					  <button type="button" id="updatePurchaseDetailsButton" class="btn btn-info">Actualizar</button>
					  <button type="reset" class="btn btn-info">Limpiar</button>
					</form>
				  </div> 
				</div>
					 ...
					 <form> 
					  <div class="form-row">
						...
						<div class="form-group col-md-2">
							...
							<select id="vendorDetailsStatus" name="vendorDetailsStatus" class="form-control">
								<?php include('controller/statusList.html'); ?>
							</select>
						</div>
						 <div class="form-group col-md-3">
							<label for="vendorDetailsVendorID">ID Proveedor</label>
							<input type="text" class="form-control invTooltip" id="vendorDetailsVendorID" name="vendorDetailsVendorID" autocomplete="off">
							<div id="vendorDetailsVendorIDSuggestionsDiv" class="customListDivWidth"></div>
						</div>
					  </div>
					  <div class="form-row">
						  <div class="form-group col-md-3">
							<label for="vendorDetailsVendorMobile">Teléfono Móvil 1<span class="requiredIcon">*</span></label>
							<input type="text" class="form-control invTooltip" id="vendorDetailsVendorMobile" name="vendorDetailsVendorMobile" title="Ingresa teléfono sin el código de país">
						  </div>
						  <div class="form-group col-md-3">
							<label for="vendorDetailsVendorPhone2">Teléfono Móvil 2</label>
							<input type="text" class="form-control invTooltip" id="vendorDetailsVendorPhone2" name="vendorDetailsVendorPhone2" title="Ingresa teléfono sin el código de país">
						  </div>
						  <div class="form-group col-md-6">
					  ...
					  <div class="form-group">
						<label for="vendorDetailsVendorAddress">Dirección 1<span class="requiredIcon">*</span></label>
						<input type="text" class="form-control" id="vendorDetailsVendorAddress" name="vendorDetailsVendorAddress">
					  </div>
					  <div class="form-group col-md-3">
						<label for="vendorDetailsVendorDistrict">Ciudad</label>
						<select id="vendorDetailsVendorDistrict" name="vendorDetailsVendorDistrict" class="form-control chosenSelect">
							<?php include('controller/districtList.html'); ?>
						</select>
					  </div>
					  					  
					  <button type="button" id="addVendor" name="addVendor" class="btn btn-info">Agregar Proveedor</button>
					  <button type="button" id="updateVendorDetailsButton" class="btn btn-info">Actualizar</button>
					  <button type="reset" class="btn btn-info">Limpiar</button>
				  ...
				  <div class="card-body">
					...
					<form>
					  <div class="form-row">
						...
						<div class="form-group col-md-2">
						  <label for="saleDetailsSaleID">ID de Venta</label>
						  <input type="text" class="form-control invTooltip" readonly id="saleDetailsSaleID" name="saleDetailsSaleID" title="Este campo se generará automáticamente cuando ingreses un nuevo registro" autocomplete="off">
					  ...
					  <button type="button" id="addSaleButton" class="btn btn-info">Agregar Venta</button>
					  <button type="button" id="updateSaleDetailsButton" class="btn btn-info">Actualizar</button>
					  <button type="reset" id="saleClear" class="btn btn-info">Limpiar</button>
					</form>
				  </div> 
				</div>
			  </div>
					 ...
					 <form> 
					  <div class="form-row">
						...
						<div class="form-group col-md-2">
							...
							<select id="customerDetailsStatus" name="customerDetailsStatus" class="form-control">
								<?php include('controller/statusList.html'); ?>
							</select>
						</div>
						 <div class="form-group col-md-3">
					  ...
					  <div class="form-row">
						  <div class="form-group col-md-3">
							<label for="customerDetailsCustomerMobile">Teléfono 1<span class="requiredIcon">*</span></label>
							<input type="text" class="form-control invTooltip" id="customerDetailsCustomerMobile" name="customerDetailsCustomerMobile" title="Ingresar solo número sin código país">
						  </div>
						  <div class="form-group col-md-3">
							<label for="customerDetailsCustomerPhone2">Teléfono 2</label>
							<input type="text" class="form-control invTooltip" id="customerDetailsCustomerPhone2" name="customerDetailsCustomerPhone2" title="Ingresar solo número sin código país">
						  </div>
						  <div class="form-group col-md-6">
					  ...
					  <div class="form-group">
						<label for="customerDetailsCustomerAddress">Dirección 1<span class="requiredIcon">*</span></label>
					  ...
					  <form>					  
					  <button type="button" id="addCustomer" name="addCustomer" class="btn btn-info">Agregar Cliente</button>
					  <button type="button" id="updateCustomerDetailsButton" class="btn btn-info">Actualizar</button>
					  <button type="reset" class="btn btn-info">Limpiar</button>
			  ...
			  <div class="tab-pane fade" id="v-pills-search" role="tabpanel" aria-labelledby="v-pills-search-tab">
				<div class="card card-outline-secondary my-4">
				  <div class="card-header">Búsqueda de Inventario<button id="searchTablesRefresh" name="searchTablesRefresh" class="btn btn-warning float-right btn-sm">Actualizar</button></div>
				  <div class="card-body">										
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item">
					...
					<div class="tab-content">
						<div id="itemSearchTab" class="container-fluid tab-pane active">
						  <br>
						  <p>Use la cuadrícula a continuación para buscar todos los detalles de los artículos</p>
						...
						<div id="customerSearchTab" class="container-fluid tab-pane fade ">
						  <br>
						  <p>Utilice la cuadrícula a continuación para buscar todos los detalles de los clientes</p>
							<div class="table-responsive" id="customerDetailsTableDiv"></div>
						</div>
						<div id="saleSearchTab" class="container-fluid tab-pane fade">
							<br>
							<p>Utilice la cuadrícula a continuación para buscar detalles de venta</p>
						...
						<div id="vendorSearchTab" class="container-fluid tab-pane fade">
							<br>
							<p>Utilice la cuadrícula a continuación para buscar detalles de proveedores</p>
			  ...
			  <div class="tab-pane fade" id="v-pills-reports" role="tabpanel" aria-labelledby="v-pills-reports-tab">
				<div class="card card-outline-secondary my-4">
				  <div class="card-header">Reportes<button id="reportsTablesRefresh" name="reportsTablesRefresh" class="btn btn-warning float-right btn-sm">Actualizar</button></div>
				  <div class="card-body">										
					<ul class="nav nav-tabs" role="tablist">
						<!-- <li class="nav-item">
						...
						<!-- <li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#vendorReportsTab">Proveedor</a>
						</li> -->
					</ul>
					...
					<div class="tab-content">
						<div id="itemReportsTab" class="container-fluid tab-pane active">
							<br>
							<p>Use la cuadrícula a continuación para obtener informes de artículos</p>
							<div class="table-responsive" id="itemReportsTableDiv"></div>
						</div>
						<div id="customerReportsTab" class="container-fluid tab-pane fade">
							<br>
							<p>Utilice la siguiente cuadrícula para obtener informes para los clientes</p>
						...
						<div id="saleReportsTab" class="container-fluid tab-pane fade">
							...
							<form> 
							  <div class="form-row">
								  <div class="form-group col-md-3">
									<label for="saleReportStartDate">Fecha de Inicio</label>
						...
						<div id="purchaseReportsTab" class="container-fluid tab-pane fade">
							...
							<form> 
							  <div class="form-row">
								  <div class="form-group col-md-3">
									<label for="purchaseReportStartDate">Fecha de Inicio</label>
						...
						<div id="vendorReportsTab" class="container-fluid tab-pane fade">
							<br>
							<p>Utilice la cuadrícula a continuación para obtener informes para los proveedores</p>
